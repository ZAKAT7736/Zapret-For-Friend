...
--filter-tcp=80,443 --ipset="ipset-telegram.txt" --dpi-desync=split2 --dpi-desync-any-protocol --dpi-desync-split-pos=2 --new ^
--filter-udp=443 --ipset="ipset-telegram.txt" --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-repeats=6 --new ^
